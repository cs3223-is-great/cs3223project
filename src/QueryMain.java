...
public class QueryMain{
	...
	public static void main(String[] args){
		...
		System.out.println("Hi enter the number of bytes per page");
	...
	System.out.println();
		...
		Operator root = null;
		if (numJoin >= 0 && !isDistinct) {// DynamicProgrammingOptimizer
			DynamicOptimizer dynamicOptimizer = new DynamicOptimizer(
					sqlquery);
			Operator logicalroot = dynamicOptimizer.getOptimizedPlan();
